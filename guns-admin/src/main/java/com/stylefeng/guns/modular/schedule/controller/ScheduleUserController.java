...
import com.stylefeng.guns.modular.schedule.service.IScheduleUserService;
...
public class ScheduleUserController extends BaseController {

    private String PREFIX = "/schedule/user/";

    @Autowired
    private IScheduleUserService scheduleUserService;
    ...
    public String userEdit(@PathVariable Integer userId, Model model) {
        ...
        assertAuth(userId);
        User user = this.scheduleUserService.selectById(userId);
    ...
    public Object changePwd(@RequestParam String oldPwd, @RequestParam String newPwd, @RequestParam String rePwd) {
        ...
        Integer userId = ShiroKit.getUser().getId();
        User user = scheduleUserService.selectById(userId);
    ...
    public Tip add(@Valid UserDto user, BindingResult result) {
        ...
        // 判断账号是否重复
        User theUser = scheduleUserService.getByAccount(user.getAccount());
        if (theUser != null) {
    ...
    public Tip edit(@Valid UserDto user, BindingResult result) throws NoPermissionException {
        ...
        if (ShiroKit.hasRole(Const.ADMIN_NAME)) {
            this.scheduleUserService.updateById(UserFactory.createUser(user));
            return SUCCESS_TIP;
        } else {
    ...
    public Tip delete(@RequestParam Integer userId) {
        ...
        assertAuth(userId);
        this.scheduleUserService.setStatus(userId, ManagerStatus.DELETED.getCode());
        return SUCCESS_TIP;
    }
    ...
    public User view(@PathVariable Integer userId) {
        ...
        assertAuth(userId);
        return this.scheduleUserService.selectById(userId);
    }
    ...
    public Tip reset(@RequestParam Integer userId) {
        ...
        this.scheduleUserService.updateById(user);
        return SUCCESS_TIP;
    }
    ...
    public Tip setRole(@RequestParam("userId") Integer userId, @RequestParam("roleIds") String roleIds) {
        ...
        assertAuth(userId);
        this.scheduleUserService.setRoles(userId, roleIds);
        return SUCCESS_TIP;
    }
