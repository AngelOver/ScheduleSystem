...
public class ScheduleAdminController extends BaseController {
    ...
    private String PREFIX = "/schedule/admin/";

    @Autowired
    private IScheduleAdminService scheduleAdminService;
    ...
    public String userEdit(@PathVariable Integer userId, Model model) {
        ...
        assertAuth(userId);
        User user = this.scheduleAdminService.selectById(userId);
    ...
    public Object changePwd(@RequestParam String oldPwd, @RequestParam String newPwd, @RequestParam String rePwd) {
        ...
        Integer userId = ShiroKit.getUser().getId();
        User user = scheduleAdminService.selectById(userId);
    ...
    public Object list(@RequestParam(required = false) String name, @RequestParam(required = false) String beginTime, @RequestParam(required = false) String endTime, @RequestParam(required = false) Integer deptid) {
        if (ShiroKit.isAdmin()) {
            List<Map<String, Object>> users = scheduleAdminService.selectUsers(null, name, beginTime, endTime, deptid);
            return new UserWarpper(users).warp();
        } else {
            DataScope dataScope = new DataScope(ShiroKit.getDeptDataScope());
            List<Map<String, Object>> users = scheduleAdminService.selectUsers(dataScope, name, beginTime, endTime, deptid);
            return new UserWarpper(users).warp();
        }
    }
    ...
    public Tip add(@Valid UserDto user, BindingResult result) {
        ...
        // 判断账号是否重复
        User theUser = scheduleAdminService.getByAccount(user.getAccount());
        if (theUser != null) {
    ...
    public Tip edit(@Valid UserDto user, BindingResult result) throws NoPermissionException {
        ...
        if (ShiroKit.hasRole(Const.ADMIN_NAME)) {
            this.scheduleAdminService.updateById(UserFactory.createUser(user));
            return SUCCESS_TIP;
        } else {
    ...
    public Tip delete(@RequestParam Integer userId) {
        ...
        assertAuth(userId);
        this.scheduleAdminService.setStatus(userId, ManagerStatus.DELETED.getCode());
        return SUCCESS_TIP;
    }
    ...
    public User view(@PathVariable Integer userId) {
        ...
        assertAuth(userId);
        return this.scheduleAdminService.selectById(userId);
    }
    ...
    public Tip reset(@RequestParam Integer userId) {
        ...
        this.scheduleAdminService.updateById(user);
        return SUCCESS_TIP;
    }
    ...
    public Tip setRole(@RequestParam("userId") Integer userId, @RequestParam("roleIds") String roleIds) {
        ...
        assertAuth(userId);
        this.scheduleAdminService.setRoles(userId, roleIds);
        return SUCCESS_TIP;
    }
