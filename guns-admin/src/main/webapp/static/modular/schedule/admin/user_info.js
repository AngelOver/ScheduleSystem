...
UserInfoDlg.addSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Feng.ctxPath + "/scheduleAdmin/add", function (data) {
        Feng.success("添加成功!");
...
UserInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Feng.ctxPath + "/scheduleAdmin/edit", function (data) {
        Feng.success("修改成功!");
...
UserInfoDlg.chPwd = function () {
    var ajax = new $ax(Feng.ctxPath + "/scheduleAdmin/changePwd", function (data) {
        Feng.success("修改成功!");
    }, function (data) {
        Feng.error("修改失败!" + data.responseJSON.message + "!");
    });
