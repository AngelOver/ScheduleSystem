...
CREATE TABLE `note` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='便签表';
...
CREATE TABLE `plan` (
  ...
  `version` int(11) DEFAULT NULL COMMENT '保留字段',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='计划表';
...
insert  into `sys_system`(`id`,`website_name`,`website_code`,`website_url`,`logo`,`toptitle`,`keyword`,`describe`,`username`,`tel`,`hotline`,`address`,`email`,`about`) values (1,'日程管理系统','SS','a3r.top','',NULL,'日程管理','毕业设计，基于mybatis的日程管理系统','张亮','17607121045','17607121045','武汉纺织大学','2424123787@qq.com','无');
